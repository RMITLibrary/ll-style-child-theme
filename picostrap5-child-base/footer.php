...
<script type="text/javascript" src="/wp-content/themes/picostrap5-child-base/js/main-body.js?v=1.0.9"></script>

<!-- Code to handle resizing iframes on this page -->
<script type="text/javascript" src="/wp-content/themes/picostrap5-child-base/js/iframeResizer.min.js"></script>
    <script type="text/javascript">
        iFrameResize({log:true});
    </script>

<!-- Code to handle this page being resized by other wordpress pages, e.g. embed mode described in main-body.js -->
<script src="/wp-content/themes/picostrap5-child-base/js/iframeResizer.contentWindow.min.js"></script>
<script src="/wp-content/themes/picostrap5-child-base/js/ltiTriggerResize.js"></script>
</body>
</html>
